...
from methods.protonet_c_fu_zheng import ProtoNet
...
if __name__ == '__main__':
    ...
    model = model.cuda()
    # model save path
    params.checkpoint_dir = './checkpoints/%s/fu/%s_%s_%s_%s' % (params.dataset, params.model, params.method, params.fake, params.true)
    ...
    end_time = time.time()
    metatrain_all_time = end_time - start_time
    str_data = 'metatrain_all_time_'+str(params.n_shot)+':'+str(metatrain_all_time)
