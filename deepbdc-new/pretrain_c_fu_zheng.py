...
from methods.template_c_fu_zheng import BaselineTrain
from utils import *
...
if __name__ == '__main__':
    ...
    parser.add_argument('--true', default=1, type=int, help='fake image number')
    ...
    elif params.dataset == 'rareairplane':
        base_file = 'base.json'
        val_file =  'val.json'
        json_file_read = True
    ...
    elif params.dataset == 'mtarsi_2':
        base_file = 'base.json'
        val_file =  'val.json'
        json_file_read = True
        params.num_classes = 42
    elif params.dataset == 'hrsc_20':
        base_file = 'base.json'
        val_file =  'val.json'
        json_file_read = True
        params.num_classes = 20
    ...
    params.checkpoint_dir = './checkpoints/fu_zheng/%s/%s_%s_%s_%s' % (params.dataset, params.model, params.method,params.fake,params.true)
    ...
    end_time = time.time()
    pretrain_all_time = end_time - start_time
    str_data = 'pretrain_all_time:'+str(pretrain_all_time)
    path_file_name = '/home/chenxu/mit2023/cx_work/DEEPBDC-new/scripts/mini_imagenet/run_protonet_c/time_report_'+str(params.fake)+'.txt'
