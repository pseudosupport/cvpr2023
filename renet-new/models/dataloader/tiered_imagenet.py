...
class tieredImageNet(Dataset):
    ...
    def __init__(self, setname, args=None, return_path=False):
        data_dir = '/home/chenxu/mit2023/cx_work/remote_sensing_dataset'
        TRAIN_PATH = osp.join(data_dir, 'tiered_imagenet/train')
        VAL_PATH = osp.join(data_dir, 'tiered_imagenet/val')
        TEST_PATH = osp.join(data_dir, 'tiered_imagenet/test')
        if setname == 'train':
            THE_PATH = TRAIN_PATH
        elif setname == 'test':
            THE_PATH = TEST_PATH
